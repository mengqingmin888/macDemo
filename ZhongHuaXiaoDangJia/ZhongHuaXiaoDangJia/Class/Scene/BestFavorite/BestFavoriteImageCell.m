...
@implementation BestFavoriteImageCell
...
- (void)setBestFood:(FoodModel *)bestFood
{
    if (_bestFood != bestFood) {
        [_bestFood release];
        _bestFood = [bestFood retain];
    }
    //菜名
    _nameLabel.text = bestFood.name;
    //收藏数量
    _clickCountLabel.text = bestFood.clickCount;
