...
- (void)setSearchFood:(FoodModel *)searchFood
{
    if (_searchFood != searchFood) {
        [_searchFood release];
        _searchFood = [searchFood retain];
    }
    //菜名
    _nameLabel.text = searchFood.name;
    //收藏数量
    _clickCountLabel.text = searchFood.clickCount;
